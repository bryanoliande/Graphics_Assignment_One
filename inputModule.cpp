...
//sets motionMode depending on which direction the cube is to be moved - mouseMoveHandler uses this.
...
//moves the cube around according to mouse movement after you click in the frame.
